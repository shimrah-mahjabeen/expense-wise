      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          <TextField
            ...
            id="title"
            label="Title"
            value={data.title.value === "" ? titleValue : data.title.value}
            onChange={(e) => {
              let formData = { ...data };
          ...
          <TextField
            ...
            id="type"
            label="type"
            value={data.type.value === "" ? typeValue : data.type.value}
            onChange={(e) => {
              let formData = { ...data };
          ...
          <TextField
            ...
            id="amount"
            label="amount"
            value={data.amount.value === "" ? amountValue : data.amount.value}
            onChange={(e) => {
              let formData = { ...data };
          ...
          >
            ...
            <Select
              ...
              label="Status*"
              id="status"
              value={data.status.value === "" ? statusValue : data.status.value}
              onChange={(e) => {
                let formData = { ...data };
